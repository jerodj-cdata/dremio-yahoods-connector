...
@SourceType(value = "YahooDSARP", label = "YahooDS",uiConfig = "yahoods-layout.json")
public class YahooDSConf extends AbstractArpConf<YahooDSConf> {
  private static final String ARP_FILENAME = "arp/implementation/yahoods-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.yahoods.YahooDSDriver";
